...
@section('title', 'Humas Monitoring Console - E-Jurnal')
...
<div class="space-y-gutter">
    ...
    <div class="grid grid-cols-12 gap-gutter">
        ...
        <div class="col-span-12 lg:col-span-8 bg-surface-container-lowest border border-outline-variant rounded-xl p-6 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div class="flex justify-between items-start mb-4">
                ...
                <div class="flex gap-2">
                    <span class="bg-secondary-container text-on-secondary-container px-3 py-1 rounded-full font-label-caps text-[10px]">+2.4% vs Kemarin</span>
                </div>
            </div>
            <div class="flex items-end gap-8 mt-4">
                <div class="flex-1">
                    <div class="flex items-end gap-2 mb-2">
                        <span class="font-display-lg text-display-lg text-primary">94.2%</span>
                    ...
                    <div class="w-full h-4 bg-surface-container-high rounded-full overflow-hidden">
                        <div class="h-full bg-secondary w-[94.2%] transition-all duration-1000 ease-out"></div>
                    </div>
                </div>
                <div class="hidden md:flex gap-4">
                    <div class="text-center">
                        <p class="font-label-caps text-[10px] text-on-surface-variant">TEPAT WAKTU</p>
                        <p class="font-headline-md text-headline-md text-secondary">112</p>
                    </div>
                    <div class="text-center">
                        <p class="font-label-caps text-[10px] text-on-surface-variant">TERLAMBAT</p>
                        <p class="font-headline-md text-headline-md text-on-tertiary-container">8</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Quick Action Card -->
        <div class="col-span-12 lg:col-span-4 bg-primary text-on-primary rounded-xl p-6 flex flex-col justify-between group cursor-pointer hover:bg-primary-container transition-all">
    ...
    <div class="grid grid-cols-12 gap-gutter">
                ...
                <div class="divide-y divide-outline-variant">
                    @forelse($unreportedClasses as $class)
                        <div class="p-4 hover:bg-error-container/5 transition-colors flex items-center justify-between">
                            ...
                            <button class="text-error hover:bg-error-container px-3 py-1 rounded font-label-caps text-[10px] border border-error remind-teacher" data-teacher="{{ $class->teacher }}">
                                INGATKAN
                            </button>
                        </div>
                    @empty
        ...
        <div class="col-span-12 lg:col-span-7 bg-surface-container-lowest border border-outline-variant rounded-xl flex flex-col">
            <div class="p-6 border-b border-outline-variant flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    <button class="bg-primary text-on-primary px-4 py-1.5 rounded-lg font-label-caps text-[11px] flex items-center gap-2">
