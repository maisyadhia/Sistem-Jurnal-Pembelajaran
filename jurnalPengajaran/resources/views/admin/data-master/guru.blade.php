...
@section('title', 'Data Guru - E-Jurnal')
...
<div class="flex flex-wrap gap-2 mb-4">
    <!-- Tombol Export -->
    <a href="{{ route('data-master.export.guru') }}" 
    ...
    <!-- Form Import -->
    <form method="POST" action="{{ route('data-master.import.guru') }}" 
...
<div class="bg-surface-container-lowest border border-outline-variant rounded-xl">
    <div class="p-6 border-b border-outline-variant flex justify-between items-center">
        <div>
            <h2 class="font-headline-md text-headline-md text-on-background">Data Guru</h2>
            <p class="font-body-sm text-body-sm text-on-surface-variant">Kelola data guru.</p>
        </div>
            ...
            <table class="w-full text-left">
                <thead class="bg-surface-container-low border-b border-outline-variant">
                    <tr>
                        ...
                        <th class="px-4 py-3 font-label-caps text-label-caps text-on-surface-variant">NIK</th>
                        ...
                        <tr class="hover:bg-surface-container-low transition-colors">
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-data-tabular text-data-tabular">{{ $item->nama_guru }}</span>
                                </div>
                            </td>
                            <td class="px-4 py-4">{{ $item->kode_guru }}</td>
                            <td class="px-4 py-4">{{ $item->nik }}</td>
                            <td class="px-4 py-4">
                            ...
                            <td class="px-4 py-4 text-right">
                                <div class="flex justify-end gap-1">
                                    ...
                                    <button onclick="openDeleteModal('{{ $item->id }}', '{{ $item->nama_guru }}', 'GURU')" 
...
document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
    ...
    let route = '/admin/data-master/guru/' + id;
